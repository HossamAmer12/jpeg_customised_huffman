...
public:
	...
	// idct coefficints conainre 
	vector<vector<double>> cosine_idct;
	...
	// added by sep 
	double writeyuv(); 
	void write_buff(vector<vector<uint_8>> &buffer  , vector<int>& zigZagArray, int quantizationTable[8][8], int currentComponent);
